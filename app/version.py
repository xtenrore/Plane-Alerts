...
# v5.3 reuses observer-independent aircraft motion across users and adds bounded
# spatial candidate filtering. The authoritative physical model is unchanged.
